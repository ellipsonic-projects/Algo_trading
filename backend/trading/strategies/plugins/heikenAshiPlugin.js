...
class HeikenAshiPlugin extends BaseStrategy {
  static manifest = {
    id: 'HeikenAshi',
    name: 'Heiken Ashi Trend Strategy',
    version: '1.0.0',
    engineVersion: '1.0.0',
    description: 'Trend following strategy using dual Heiken Ashi agreement, EMA, and JMA filter.',
    requires: {
    ...
    parameters: {
      ...
      slPoints: { type: 'number', default: 30, label: 'Stop Loss Points' },
...
module.exports = HeikenAshiPlugin;
